...
describe("User", () => {
  ...
  describe("patch delete existing document", () => {
    it(
      "should remove specified document",
      mochaAsync(async () => {
  ...
  describe("get all user nodes", () => {
    it(
      "should return all nodes for a user",
      mochaAsync(async () => {
  ...
  describe("get trigger dummy transactions", () => {
    it(
      "should trigger dummy transactions",
      mochaAsync(async () => {
    ...
    it(
      "should trigger dummy transaction with amount",
      mochaAsync(async () => {
        const response = await testUser.triggerDummyTransactions("<NODE_ID>", {
          amount: "<AMOUNT>",
        });
  ...
  describe("get statements by user", () => {
    it(
      "should retrieve statements by specified user",
      mochaAsync(async () => {
  ...
  describe("get statements by node", () => {
    it(
      "should retrive statements by specified node",
      mochaAsync(async () => {
  ...
  describe("patch verify micro-deposits", () => {
    it(
      ...
      mochaAsync(async () => {
        ...
        const response = await testUser.verifyMicroDeposits(
          achNode.data.nodes[0]._id,
          {
            micro: [0.1, 0.1],
          }
        );
  ...
  describe("patch reinitiate micro-deposits", () => {
    it(
      "should reinitiate microdeposits",
      mochaAsync(async () => {
  ...
  describe("patch reauthenticate ach node", () => {
    it(
      "should reinitiate microdeposits",
      mochaAsync(async () => {
        const response = await testUser.reauthACHNode("<NODE_ID>");
        expect(response.status).to.equal(200);
      })
    );
  });
  ...
  describe("patch generate apple pay token", () => {
    it(
      "should generate new apple pay token",
      mochaAsync(async () => {
  ...
  describe("get transaction w/ transactionID", () => {
    it(
      "should retrive specified transaction",
      mochaAsync(async () => {
        const response = await testUser.getTransaction(
          "<NODE_ID>",
          "<TRXN_ID>"
        );
        expect(response.status).to.equal(200);
  ...
  describe("get all node transactions", () => {
    it(
      "should retrive all node transaction",
      mochaAsync(async () => {
  ...
  describe("delete transaction", () => {
    it(
      "should delete specified transaction",
      mochaAsync(async () => {
        // create transaction
        ...
        // delete transaction
        const response = await testUser.deleteTransaction(
          "<NODE_ID>",
          txn.data._id
        );
        expect(response.status).to.equal(200);
  ...
  describe("patch comment on status", () => {
    it(
      "should comment on transaction status",
      mochaAsync(async () => {
        // create transaction
        const txn = await testUser.createTransaction("<NODE_ID>", {
          to: {
        ...
        expect(txn.status).to.equal(200);
        // comment on status
        const response = await testUser.commentOnStatus(
          "<NODE_ID>",
          txn.data._id,
          {
            comment: "my comment",
  ...
  describe("patch dispute card transaction", () => {
    it(
      "should submit dispute of card transaction",
      mochaAsync(async () => {
        const response = await testUser.disputeCardTransaction(
          "<NODE_ID>",
          "<TRXN_ID>"
        );
        expect(response.status).to.equal(200);
  ...
  describe("get all subnets", () => {
    it(
      "should retrieve all user subnets",
      mochaAsync(async () => {
  ...
  describe("get subnet w/ subnetID", () => {
    it(
      "should retrieve specified subnet",
      mochaAsync(async () => {
  ...
  describe("register new fingerprint", () => {
    it(
      "should submit new fingerprint",
      mochaAsync(async () => {
        const response = await testUser.registerNewFingerprint(
          "newTestFingerprint123"
        );
    ...
    it(
      "should submit 2fa device",
      mochaAsync(async () => {
        const response = await testUser.supplyDevice2FA(
          "newTestFingerprint123",
          "<2FA_DEVICE>"
        );
        expect(response.status).to.equal(202);
  ...
  describe("verify fingerprint 2fa", () => {
    it(
      "should verify fingerprint 2fa",
      mochaAsync(async () => {
        const response = await testUser.verifyFingerprint2FA(
          "newTestFingerprint123",
          "<2FA_CODE>"
        );
        expect(response.status).to.equal(200);
